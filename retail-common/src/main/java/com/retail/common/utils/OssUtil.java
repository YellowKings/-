...
public class OssUtil {
    ...
    private static String accessKeyId = "LTAI5tRtiXVncULhrCQ3oyEY";
    private static String accessKeySecret = "ZS9abI3urvKUsdCWN2wPkEfIIIAIkz";
    private static String accessPre = "https://guochangjiang.oss-cn-shanghai.aliyuncs.com/";
    /**
     * bucket名称
     * @return
     */
    private static String bucketName = "guochangjiang";
